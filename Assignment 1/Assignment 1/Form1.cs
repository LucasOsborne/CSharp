...
namespace Assignment_1
{
    public partial class TshirtOrderFrm : Form
    {
        ...
        {
            InitializeComponent();
            TshirtCollectionDateDTPicker.CalendarMonthBackground = Color.LightGreen;
        }
        ...
        private void TshirtCalculateBtn_Click(object sender, EventArgs e)
        {
            ...
            TshirtOrderNumLbl.Text = $"No: {rnd.Next(1000)}";
            ...
            MessageBox.Show($"Surname: {TshirtSurnameBoxLbl.Text} \n " +
                $"{TshirtQauntityNumUD.Value} {ShirtSize} {ShirtMaterial} T-shirts \n " +
